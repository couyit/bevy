...
fn spawn_entities(mut commands: EntityCommands, mut entity_counter: ResMut<EntityCounter>) {
...
fn remove_old_entities(mut commands: EntityCommands, entities: Query<(Entity, &Age)>) {
