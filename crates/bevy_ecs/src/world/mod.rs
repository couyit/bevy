...
use crate::{
    ...
    bundle::{Bundle, BundleInfo, BundleInserter, BundleSpawner, InsertMode},
    change_detection::{MutUntyped, TicksMut},
    component::{
        Component, ComponentDescriptor, ComponentId, ComponentInfo, ComponentTicks, Mutable, Tick,
    },
    ...
    resource::Resource,
    resource_components::{ResourceComponents, ResourceDescriptor, ResourceId},
    result::Result,
    schedule::{Schedule, ScheduleLabel, Schedules},
    storage::{ResourceData, Resources, SubWorldId, SubWorlds},
    world::{
...
pub struct World {
    id: WorldId,
    pub(crate) sub_storages: SubWorlds,
...
impl World {
    ...
    #[inline]
    pub fn sub_storages(&self) -> &SubWorlds {
        &self.sub_storages
    }
    ...
    where
        ...
        B: Bundle,
    {
        self.insert_or_spawn_batch_in_sub_storage(iter, SubWorlds::MAIN_STORAGE)
    }
    ...
    pub fn clear_entities(&mut self) {
        for sub_storage in self.sub_storages.sub_storages.iter_mut() {
...
impl World {
    ...
    pub fn remove_resource_by_id(&mut self, component_id: ComponentId) -> Option<()> {
        self.resources.get_mut(component_id)?.remove_and_drop();
        Some(())
    }
