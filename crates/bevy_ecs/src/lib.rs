...
pub mod prelude {
    ...
    pub use crate::{
        ...
        system::{
            ComponentCommand, ComponentCommands, Deferred, EntityCommand, EntityCommands, In, InMut, InRef,
...
mod tests {
    ...
    use bevy_ecs_macros::{ComponentWorld, VisitEntities, VisitEntitiesMut};
