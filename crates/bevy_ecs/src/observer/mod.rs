...
mod tests {
    ...
    fn observer_order_recursive() {
        ...
        world.init_resource::<Order>();
        world.add_observer(
            |obs: Trigger<OnAdd, A>, mut res: ResMut<Order>, mut commands: EntityCommands| {
                res.observed("add_a");
                commands.entity(obs.target()).insert(B);
            },
        );
        world.add_observer(
            |obs: Trigger<OnRemove, A>, mut res: ResMut<Order>, mut commands: EntityCommands| {
        ...
        world.add_observer(
            |obs: Trigger<OnAdd, B>, mut res: ResMut<Order>, mut commands: EntityCommands| {
                res.observed("add_b");
    ...
    fn observer_on_remove_during_despawn_spawn_empty() {
        ...
        world.add_observer(|_: Trigger<OnRemove, A>, mut cmd: EntityCommands| {
    ...
    fn observer_invalid_params() {
        ...
        world.add_observer(|_: Trigger<EventA>, _: Res<ResA>, mut commands: EntityCommands| {
    ...
    fn observer_apply_deferred_from_param_set() {
        ...
        let mut world = World::new();
        world.add_observer(
            |_: Trigger<EventA>, mut params: ParamSet<(Query<Entity>, EntityCommands)>| {
