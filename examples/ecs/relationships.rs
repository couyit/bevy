...
fn main() {
    ...
    fn spawning_entities_with_relationships(mut commands: EntityCommands) {
    ...
    fn mutate_relationships(name_query: Query<(Entity, &Name)>, mut commands: EntityCommands) {
    ...
    fn untarget(mut commands: EntityCommands, name_query: Query<(Entity, &Name)>) {
