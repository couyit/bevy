...
fn spawn_tasks(mut commands: EntityCommands) {
...
fn handle_tasks(mut commands: EntityCommands, mut transform_tasks: Query<&mut ComputeTransform>) {
...
fn setup_env(mut commands: EntityCommands) {
