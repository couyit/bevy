...
fn setup_cameras(mut commands: EntityCommands, mut game: ResMut<Game>) {
...
fn setup(mut commands: EntityCommands, asset_server: Res<AssetServer>, mut game: ResMut<Game>) {
...
fn display_score(mut commands: EntityCommands, game: Res<Game>) {
    commands.spawn((
