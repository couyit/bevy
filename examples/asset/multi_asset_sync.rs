...
fn setup_assets(mut commands: EntityCommands, asset_server: Res<AssetServer>) {
...
fn despawn_loading_state_entities(mut commands: EntityCommands, loading: Query<Entity, With<Loading>>) {
