...
fn setup_cameras(mut commands: EntityCommands) {
...
fn setup_lights(mut commands: EntityCommands) {
    commands.spawn((
        PointLight {
            intensity: 5000.0,
            ..default()
...
fn setup_text(mut commands: EntityCommands, cameras: Query<(Entity, &Camera)>) {
